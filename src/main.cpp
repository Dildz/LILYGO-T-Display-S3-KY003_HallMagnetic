...
*
* Notes:
*  - Signal on GPIO1 is active low, this means that when a magnetic field is detected, there is 0V on the pin.
      If no magnetic field is detected, there is 3.3V on the pin. We start with sensor state HIGH.
**********************************************************************************************************/
